    ...
    generate() {
            ...
            for (const m of modules) {
                ...
                moduleIdToSourceMapping.set(id, Template.asString([
                    ...
                    Template.indent([
                        ...
                        `shareScope: ${JSON.stringify(Array.isArray(shareOption.shareScope)
        ...
        return Template.asString([
            ...
            this._runtimeRequirements.has(RuntimeGlobals.ensureChunkHandlers)
                ? Template.asString([
                    `${RuntimeGlobals.require}.consumesLoadingData.chunkMapping = ${JSON.stringify(chunkToModuleMapping, null, '\t')};`,
