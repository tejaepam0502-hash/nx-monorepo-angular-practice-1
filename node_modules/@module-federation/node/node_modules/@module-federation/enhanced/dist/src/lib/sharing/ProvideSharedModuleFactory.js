...
class ProvideSharedModuleFactory extends ModuleFactory {
    ...
    create(data, callback) {
        const dep = data
            .dependencies[0];
        callback(null, {
            module: new ProvideSharedModule_1.default(dep.shareScope, dep.name, dep.version, dep.request, dep.eager, dep.requiredVersion, dep.strictVersion, dep.singleton, dep.layer, dep.treeShakingMode),
        });
    }
}
