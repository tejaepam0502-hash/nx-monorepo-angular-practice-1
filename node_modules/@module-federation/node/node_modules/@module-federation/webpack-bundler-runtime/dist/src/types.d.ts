...
import type { Remote, RemoteEntryInitOptions, SharedConfig, SharedGetter, TreeShakingArgs } from '@module-federation/runtime/types';
...
export interface Federation {
    ...
    bundlerRuntime?: {
        ...
        init: ({ webpackRequire, libraryType, }: {
            webpackRequire: WebpackRequire;
            libraryType: string;
        }) => void;
