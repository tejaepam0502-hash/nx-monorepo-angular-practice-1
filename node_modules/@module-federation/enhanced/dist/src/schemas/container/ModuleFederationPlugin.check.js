                    ...
                    if (a) {
                        ...
                        if (a) {
                            if (void 0 !== e.export) {
                                ...
                                if (!s) {
                                    const e = { params: {} };
                                    return (null === o ? (o = [e]) : o.push(e), i++, (c.errors = o), !1);
                                }
                                (i = n),
            ...
            if (t === a) {
                ...
                if (l) {
                    if (void 0 !== e.exclude) {
                        ...
                        if (!o) {
                            const e = { params: {} };
                            return (null === i ? (i = [e]) : i.push(e), a++, (v.errors = i), !1);
                        }
                        if (((a = s),
                                                                    ...
                                                                    if (l) {
                                                                        if (void 0 !== e.version) {
                                                                            ...
                                                                            if (!1 !== t) {
                                                                                const e = {
                                                                                    params: {
                                                                                        allowedValues: h.properties.version.anyOf[0]
                                                                                            .enum,
                                                                                    },
                                                                                };
                                                                                null === i ? (i = [e]) : i.push(e), a++;
...
function A(o, { instancePath: i = '', parentData: a, parentDataProperty: p, rootData: f = o, } = {}) {
    let u = null, y = 0;
    if (0 === y) {
                                            ...
                                            if (b) {
                                                ...
                                                if (b) {
                                                    if (void 0 !== o.shareStrategy) {
                                                        ...
                                                        const r = y;
                                                        if ('string' != typeof e)
                                                            return ((A.errors = [{ params: { type: 'string' } }]),
                                                                !1);
